using SalesWebNet6.Models.Enums; 
...
namespace SalesWebNet6.Data
{
    ...
    {
        private SalesWebNet6Context _context;

        public SeedingService(SalesWebNet6Context context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 12, 8), 1500.00, d1);
